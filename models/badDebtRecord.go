...
type BadDebtRecord struct {
	...
	BalanceBefore      decimal.Decimal `json:"balance_before" gorm:"column:balance_before;type:decimal(20,6);not null;default:0.000000"`   // 执行前余额（这里记录有负值，实际上中台系统的用户余额是无负数的）
