...
type User struct {
	...
	MerchantId       int32  `json:"merchant_id" gorm:"merchant_id"`             // 商户ID
	...
	Status           int8   `json:"status" gorm:"status"`                       // 用户状态 1:正常 2:冻结 3:禁用 4:注销
	AccountType      int8   `json:"account_type" gorm:"account_type"`           // 账号类型 1:正式账号 2:测试账号
	RiskLevel        int8   `json:"risk_level" gorm:"risk_level"`               // 风险等级 1:正常 2:低风险 3:中风险 4:高风险
