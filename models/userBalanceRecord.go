...
type UserBalanceRecord struct {
	...
	Amount          float64 `json:"amount" gorm:"amount"`                       // 变动金额（正数表示增加，负数表示减少）
	BalanceBefore   float64 `json:"balance_before" gorm:"balance_before"`       // 变动前余额
	BalanceAfter    float64 `json:"balance_after" gorm:"balance_after"`         // 变动后余额
