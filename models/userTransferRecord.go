...
type UserTransferRecord struct {
	...
	Amount                float64 `json:"amount" gorm:"amount"`                                   // 转账金额
	CurrencyCode          string  `json:"currency_code" gorm:"currency_code"`                     // 币种代码
	FeeAmount             float64 `json:"fee_amount" gorm:"fee_amount"`                           // 手续费金额
	ActualAmount          float64 `json:"actual_amount" gorm:"actual_amount"`                     // 实际到账金额
	...
	PlatformTransactionId string  `json:"platform_transaction_id" gorm:"platform_transaction_id"` // 第三方交易ID
	...
	MerchantOrderNo       string  `json:"merchant_order_no" gorm:"merchant_order_no"`             // 下游业务订单号
